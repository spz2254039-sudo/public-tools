...
(function () {
  ...
  // V7 變更重點：
  // 1. 匯出 Excel 改為只匯出「已完成案件」（有檢查案號的筆數）。
  // 2. 修正 xlsx OOXML 結構，避免 Excel 開啟時出現檔案修復/recovery log。
  // 3. 調整欄寬計算，讓欄位寬度更接近 Excel 自動最佳寬度，閱讀更舒適。
